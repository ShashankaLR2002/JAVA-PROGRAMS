class CountryRunner1 {
    public static void main(String[] args) 
	{
        ...
        Country1.primeministers(ministers);
        ...
        Country1.cabinetMinisters(cabinetMinisters);
	}
}